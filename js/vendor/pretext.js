/* =====================================================================
 * pretext.js — vendored copy of @chenglou/pretext v0.0.7
 *
 * Source:      https://github.com/chenglou/pretext
 * Version:     0.0.7 (pinned via utils/pretext git submodule)
 * npm:         https://www.npmjs.com/package/@chenglou/pretext
 * License:     MIT — Copyright (c) Cheng Lou and pretext contributors
 *
 * This file is a self-hosted build of the pretext text-measurement
 * library, served directly from the repo to remove the runtime CDN
 * dependency. The submodule at utils/pretext/ is the canonical source
 * reference — when upgrading, re-run the build there and replace this
 * file.
 *
 * Why vendored?  The library uses the browser canvas API to measure
 * text without forcing DOM reflows. It is loaded asynchronously as an
 * ES module from every page; the dynamic sizing in js/pretext-dynamic.js
 * degrades gracefully (no-op) if the import fails.
 * ===================================================================== */
